<%-- 
    ...
    Created on : May 3, 2017, 2:11:30 AM
    Author     : liwenfan
--%>
    ...
    <body>
        ...
        <div id="title-bg">
         <div id="title-div" class="container">
           <span id="page-title">FILTER BY MOVIE GENRES - [ ${GenreName} ]</span>
         </div>
        </div>
        <div>
        <ul class="navbar-floatleft nav nav-pills">
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=action">ACTION</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=drama">DRAMA</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=comedy">COMEDY</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=thriller">THRILLER</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=horror">HORROR</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=romance">ROMANCE</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=adventure">ADVENTURE</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=crime">CRIME</a></li>
            <li><a class="nav-btn" href="MovieGenresController?method=get&genre=fantasy">FANTASY</a></li>
        </ul>
        </div> 
        <br>
       
    <c:choose>
        <c:when test="${GenreResult!=null}">   
        <!-- /Title -->        
        <!-- Page Content -->
        <div class="container" style="margin-top: 70px;">
          <div class="movie-listing">
            <c:forEach var="item" items="${GenreResult}" >
